...
void main()
{
    ...
    vec2 pos = v_vTexcoord-startPos;
    
    gl_FragColor = v_vColour * texture2D( gm_BaseTexture, v_vTexcoord - intensity*normalize(pos)*length(pos)*length(pos),0.0);
}
